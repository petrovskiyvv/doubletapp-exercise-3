...
//        val period = findViewById<TextInputEditText>(R.id.etPeriod)
...
//            period.setText(habit.periodicity)
//        }
//
...
//            val type =
//                if (radioGroupType.checkedRadioButtonId == R.id.radioGood) TypeHabit.GOOD else TypeHabit.BAD
//            val frequency = etQuantity.text.toString()
//            val periodicity = period.text.toString()
//
//            val newHabit = Habit(
//                name = name,
